export const T = {
  es: {
    ...
    eduList: [
      ...
      { name: "Data Analytics con Python · Business Intelligence",  inst: "Talento Tech",                  year: "2025",            cert: "talento-tech-bi.pdf" },
      { name: "Programación en la Nube",                           inst: "AWS Academy",                   year: "2025",            cert: "aws-cloud-foundations.pdf" },
      { name: "Diplomatura en Investigación de Ciberdelitos",       inst: "UNLZ",                          year: "2023",            cert: "diplomatura-ciberdelitos-unlz.jpg" },
      { name: "Evidencia Digital",                                  inst: "Embajada EE.UU. / ATA",         year: "2023",            cert: "evidencia-digital-ata.pdf" },
      { name: "Excel avanzado · Power BI · MySQL",                  inst: "UTN",                           year: "2023",            cert: "utn-excel-powerbi.pdf" },
      { name: "Programación Web con Node.js",                       inst: "Codo a Codo 4.0",               year: "2023",            cert: "codo-a-codo-nodejs.pdf" },
      { name: "Lic. en Investigación Criminal",                     inst: "IUPFA",                         year: "Tesis pendiente", cert: null },
      { name: "Tec. Universitaria en Seguridad Ciudadana",          inst: "IUPFA",                         year: "2022",            cert: "terciario-iupfa.pdf" },
      { name: "CEH v10 — Certified Ethical Hacker",                 inst: "UTN",                           year: "2019",            cert: "ceh-v10-utn.pdf" },
    ],
    contact: {
      label: "Contacto",
      title: "Hablemos",
  ...
  en: {
    ...
    education: { label: "Education & Certifications", viewCert: "View certificate" },
    eduList: [
      { name: "Higher Technical Degree in Software Development",  inst: "IFTS N° 29",                  year: "2025",           cert: "ifts-terciario.pdf" },
      { name: "Data Analytics with Python · Business Intelligence", inst: "Talento Tech",              year: "2025",           cert: "talento-tech-bi.pdf" },
      { name: "Cloud Programming",                                inst: "AWS Academy",                  year: "2025",           cert: "aws-cloud-foundations.pdf" },
      { name: "Cybercrime Investigation Diploma",                 inst: "UNLZ",                         year: "2023",           cert: "diplomatura-ciberdelitos-unlz.jpg" },
      { name: "Digital Evidence",                                 inst: "US Embassy / ATA",             year: "2023",           cert: "evidencia-digital-ata.pdf" },
      { name: "Advanced Excel · Power BI · MySQL",               inst: "UTN",                           year: "2023",           cert: "utn-excel-powerbi.pdf" },
      { name: "Web Programming with Node.js",                    inst: "Codo a Codo 4.0",               year: "2023",           cert: "codo-a-codo-nodejs.pdf" },
      { name: "B.S. in Criminal Investigation",                  inst: "IUPFA",                         year: "Thesis pending", cert: null },
      { name: "University Degree in Public Safety",              inst: "IUPFA",                         year: "2022",           cert: "terciario-iupfa.pdf" },
      { name: "CEH v10 — Certified Ethical Hacker",              inst: "UTN",                           year: "2019",           cert: "ceh-v10-utn.pdf" },
    ],
    contact: {
      label: "Contact",
